                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          width: 180,
                          child: MultiPickLookup<MenuTypeModel>(
                            selectedItems: state.menuTypes,
                            hintText: 'Menu types',
                            items: lookup.menuTypes!,
                            getText: (item) => item.names!.join(' - '),
                            onChanged: (value) {
                              bloc.updateField(menuTypes: value);
                            },
                          ),
                        ),
                        Container(
                          width: 180,
                          child: MultiPickLookup<SpecialGoalModel>(
                            selectedItems: state.specialGoals,
                            hintText: 'Special goals',
                            items: lookup.goals!,
                            getText: (item) => item.names!.join(' - '),
                            onChanged: (value) {
                              bloc.updateField(specialGoals: value);
                            },
                          ),
                        ),
                      ],
